...
WORK_ROOT=/root/paddlejob/workspace/work/liuyiqun/models
...
OUTPUT_FILENAME=paddle_${MODEL_TYPE}.gbs${GBS}_mp${MP}pp${PP}sd${SD}_vpp${VPP}_mbs${MBS}_acc${ACC_STEPS}.20240422
...
task_name="gpt3_hand_mp2pp4_base_perf"
